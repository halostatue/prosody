...
Contribution to Prosody is encouraged: bug reports, discussions, feature
...
Prosody is governed under the [Contributor Covenant Code of Conduct][cccoc].
...
Prosody contributions must be well understood by the submitter and that the
...
> I developed Prosody using [Kiro][kiro] in both "vibe" and "spec" modes using
> various Claude models. Before releasing, I performed a _thorough_ review and
> rewrite of substantial sections of the code as the model generated deeply
...
Austin Ziegler created Prosody.
